    ...
    if user_choice1 == '1': #Will allow user to input their username and password
        ...
        if current_user == "Admin":  #Will determine if the user is the admin
            ...
            while flag == True:
                ...
                regular.options() #Display the options of the regular
                user_choice2 = input("\nYour Choice: ")
                
                flag2 = True

                while flag2 == True:
                    if user_choice2 == '1': #for Announcement
                        pass

                    elif user_choice2 == '2': #for Liabilities
                    ...
                    elif user_choice2 == '3': #for Attendance
                        print("\n[1] Time-in")
                        print("[2] Time-out")
